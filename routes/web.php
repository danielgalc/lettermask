...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Categorías (anidadas bajo edición)
    ...
    Route::delete('groups/{group}', [GroupController::class, 'destroy'])
        ->name('groups.destroy');
    Route::post('groups/{group}/ready', [GroupController::class, 'ready'])
        ->name('groups.ready');
    Route::post('groups/{group}/reveal', [GroupController::class, 'reveal'])
        ->name('groups.reveal');

    // Participaciones (miembros de un grupo)
    ...
    Route::post('votes', [VoteController::class, 'store'])
        ->name('votes.store');
    Route::get('editions/{edition}/results', [VoteController::class, 'results'])
        ->name('editions.results');
});
